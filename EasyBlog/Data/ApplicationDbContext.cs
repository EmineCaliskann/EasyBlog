        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Post>().HasData(
                new Post
                {
                    ...
                    Image = "1jpg", // Or provide a URL/path if applicable
                    CategoryId = 1
                },
                new Post
                {
                    ...
                    Image = "2jpg", // Or provide a URL/path if applicable
                    CategoryId = 1
                },
                new Post
                {
                    ...
                    Image = "3jpg", // Or provide a URL/path if applicable
                    CategoryId = 2
                },
                new Post
                {
                    ...
                    Image = "4jpg", // Or provide a URL/path if applicable
                    CategoryId = 2
                }
            );
